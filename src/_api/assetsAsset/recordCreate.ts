 ...
 * @name RecordCreate
 * @summary 资产分页列表
 * @request POST:/asset/record
 */
export const recordCreate = (root: RecordCreatePayload, params: RequestParams = {}) =>
  window.requestMethod<
    ...
    any
  >({
    url: `/api/assets/asset/record`,
    method: "POST",
    data: root,
    ...params,
  });
export type RecordCreateP = RecordCreatePayload;

export type RecordCreateR = GetData<{
  code?: number;
  msg?: string;
  data?: {
    /** 分页数据 */
